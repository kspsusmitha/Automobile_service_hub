...
public class LightsChargers_Adapter extends RecyclerView.Adapter<LightsChargers_Adapter.ViewHold> {

    private final ArrayList<materialButton> dataList;
    private final Context context;

    public LightsChargers_Adapter(Context fragment, ArrayList<materialButton> dataList) {
