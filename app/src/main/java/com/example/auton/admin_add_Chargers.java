...
public class admin_add_Chargers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (modelStr.isEmpty() || operatingvoltageStr.isEmpty() || featureStr.isEmpty() || dimensionStr.isEmpty() || weightStr.isEmpty() || manufacturerStr.isEmpty() || colorStr.isEmpty() || itemincludedStr.isEmpty() || priceStr.isEmpty() || quantityStr.isEmpty()) {
                ...
                databaseReference.child("Accessories").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Toast.makeText(admin_add_Chargers.this, "Value Entered", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(admin_add_Chargers.this, "error" + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        ...
        //      IMG UPLOAD
        binding.btnSelectCharger.setOnClickListener(v -> {
            selectImage();
        });
    }
        ...
        if (imageUri != null) {
            ...
            storageReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    binding.ivCharger.setImageURI(null);
                    Toast.makeText(admin_add_Chargers.this, "Successfully Uploaded", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(admin_add_Chargers.this, "Failed to Upload", Toast.LENGTH_SHORT).show();
    ...
    private void uploadtoFirebase(Uri uri) {
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(admin_add_Chargers.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}