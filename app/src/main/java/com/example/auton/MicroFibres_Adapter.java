...
public class MicroFibres_Adapter extends RecyclerView.Adapter<MicroFibres_Adapter.ViewHold> {
    ...
    @NonNull
    @Override
    public MicroFibres_Adapter.ViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.microfiber_layout, parent, false);
        return new MicroFibres_Adapter.ViewHold(view);
    }

    public void onBindViewHolder(MicroFibres_Adapter.ViewHold holder, int position) {
