...
import com.example.auton.databinding.ActivityAdminAddPeriodicServiceBinding;
...
public class admin_add_PeriodicService extends AppCompatActivity {
    DatabaseReference databaseReference;
    String servicenameStr, essentialserviceStr, performanceserviceStr, additionalserviceStr, priceStr, pk;
    private ActivityAdminAddPeriodicServiceBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAdminAddPeriodicServiceBinding.inflate(getLayoutInflater());
            ...
            if (servicenameStr.isEmpty() || essentialserviceStr.isEmpty() || performanceserviceStr.isEmpty() || additionalserviceStr.isEmpty() || priceStr.isEmpty()) {
                ...
                databaseReference.child("SERVICE_TYPE").child("PERIODIC_SERVICE").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(admin_add_PeriodicService.this, "error" + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
