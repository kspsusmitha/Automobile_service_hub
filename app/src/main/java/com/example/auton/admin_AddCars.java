            ...
            if (priceStr.isEmpty() || brandStr.isEmpty()) {
                ...
                databaseReference.child("Accessories").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        uploadImage();
                        Toast.makeText(admin_AddCars.this, "Value Entered", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(admin_AddCars.this, "error" + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
        //  UPLOAD IMAGE
        binding.btnSelectImgCar.setOnClickListener(v -> {
            selectImage();
        });
    }
        ...
        if (imageUri != null) {
            ...
            storageReference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    binding.ivCar.setImageURI(null);
                    Toast.makeText(admin_AddCars.this, "Successfully Uploaded", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(admin_AddCars.this, "Failed to Upload", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void uploadtoFirebase(Uri uri) {
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(admin_AddCars.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}