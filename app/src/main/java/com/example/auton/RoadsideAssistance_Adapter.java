...
public class RoadsideAssistance_Adapter extends RecyclerView.Adapter<RoadsideAssistance_Adapter.ViewHold> {

    private final ArrayList<materialButton> dataList;
    private final Context context;

    public RoadsideAssistance_Adapter(Context fragment, ArrayList<materialButton> dataList) {
