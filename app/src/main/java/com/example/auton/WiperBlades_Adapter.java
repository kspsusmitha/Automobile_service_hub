...
public class WiperBlades_Adapter extends RecyclerView.Adapter<WiperBlades_Adapter.ViewHold> {
    ...
    @NonNull
    @Override
    public WiperBlades_Adapter.ViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.wiperblades_layout, parent, false);
        return new WiperBlades_Adapter.ViewHold(view);
    }

    public void onBindViewHolder(WiperBlades_Adapter.ViewHold holder, int position) {
