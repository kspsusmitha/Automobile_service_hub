...
public class Horns_Adapter2 extends RecyclerView.Adapter<Horns_Adapter2.ViewHold> {
    private final Context context;
    private ArrayList<Accessories_ModelClass> dataList;


    public Horns_Adapter2(Context fragment, ArrayList<Accessories_ModelClass> dataList) {
    ...
    @NonNull
    @Override
    public Horns_Adapter2.ViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.horns_layout2, parent, false);
        return new Horns_Adapter2.ViewHold(view);
    }

    public void onBindViewHolder(Horns_Adapter2.ViewHold holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context.getApplicationContext(), fulldetails_Horns.class);
