...
public class Mats_Adapter2 extends RecyclerView.Adapter<Mats_Adapter2.ViewHold> {
    private final Context context;
    private ArrayList<Accessories_ModelClass> dataList;


    public Mats_Adapter2(Context fragment, ArrayList<Accessories_ModelClass> dataList) {
    ...
    @NonNull
    @Override
    public Mats_Adapter2.ViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.air_freshner_layout2, parent, false);
        return new Mats_Adapter2.ViewHold(view);
    }

    public void onBindViewHolder(Mats_Adapter2.ViewHold holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context.getApplicationContext(), fulldetails_Mats.class);
