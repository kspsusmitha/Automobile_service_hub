...
public class ACServiceRepair_ModelClass {
    ...
    public ACServiceRepair_ModelClass(String additionalServices, String essentialServices, String performanceServices, String price, String serviceName, String key) {
