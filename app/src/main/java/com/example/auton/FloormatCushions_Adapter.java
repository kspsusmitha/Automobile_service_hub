...
public class FloormatCushions_Adapter extends RecyclerView.Adapter<FloormatCushions_Adapter.ViewHold> {

    private final ArrayList<materialButton> dataList;
    private final Context context;

    public FloormatCushions_Adapter(Context fragment, ArrayList<materialButton> dataList) {
