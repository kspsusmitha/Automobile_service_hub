...
public class AirPurifier_Adapter extends RecyclerView.Adapter<AirPurifier_Adapter.ViewHold> {
    ...
    @NonNull
    @Override
    public AirPurifier_Adapter.ViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.airpurifier_layout2, parent, false);
        return new AirPurifier_Adapter.ViewHold(view);
    }

    public void onBindViewHolder(AirPurifier_Adapter.ViewHold holder, int position) {
