...
public class CarecarePurifiers_Adapter extends RecyclerView.Adapter<CarecarePurifiers_Adapter.ViewHold> {

    private final ArrayList<materialButton> dataList;
    private final Context context;

    public CarecarePurifiers_Adapter(Context fragment, ArrayList<materialButton> dataList) {
    ...
    public void onBindViewHolder(@NonNull ViewHold holder, int position) {
        ...
        holder.androidScreen.setOnClickListener(v -> {
            ...
            user_View_Carecare_Purifiers.carcarePurifiersInterface.onClickItem(dataList.get(position).getName());
